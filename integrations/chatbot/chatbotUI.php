...
<?php if (!$is_embed): ?>
    ...
    <button class="btn btn-warning rounded-circle position-fixed d-flex align-items-center justify-content-center"
        ...
        <img src="/HOTEL-MANAGEMENT-SYSTEM/images/logo/chatbot.png" alt="Chat"
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="chatbotOffcanvas" aria-labelledby="chatbotOffcanvasLabel">
        ...
        <div class="offcanvas-body d-flex p-0 overflow-auto" style="min-width:320px;max-width:420px;">
            <iframe src="/HOTEL-MANAGEMENT-SYSTEM/integrations/chatbot/chatbotUI.php?embed=1"
...
<?php if (isset($_GET['embed'])): ?>
    ...
    <head>
        ...
        <link rel="stylesheet" href="/HOTEL-MANAGEMENT-SYSTEM/css/chatbot.css">
    </head>
    ...
    <body class="d-flex flex-column vh-100 overflow-hidden"
                ...
                <div class="col-12">
                    ...
                    <div class="d-flex gap-3 align-items-start mb-3">
                        <div class="rounded-circle bg-white d-flex align-items-center justify-content-center overflow-hidden flex-shrink-0 shadow-sm"
                            ...
                            <img src="/HOTEL-MANAGEMENT-SYSTEM/images/logo/chatbot.png" alt="Bot"
        ...
        <script>
            ...
            `;
                ...
                <div class="col-12">
                    <div class="d-flex gap-3 align-items-start animate-fadeIn">
                        <div class="rounded-circle bg-white d-flex align-items-center justify-content-center overflow-hidden flex-shrink-0 shadow-sm" 
                             style="width: 36px; height: 36px;">
                            <img src="/HOTEL-MANAGEMENT-SYSTEM/images/logo/chatbot.png" alt="Bot" class="w-100 h-100 rounded-circle" style="object-fit: cover;">
                        </div>
            ...
            `;
                ...
                fetch("/HOTEL-MANAGEMENT-SYSTEM/integrations/chatbot/chatbotUI.php", {
                    method: "POST",
                    headers: {
