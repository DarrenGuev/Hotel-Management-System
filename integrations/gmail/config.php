 ...
 * 
 * This file contains all configuration settings for the Gmail integration
 * including SMTP (sending), IMAP (receiving), OAuth, and database settings.
 */
...
// Use the folder name from the workspace structure
...
/**
 * Check if Gmail is configured (OAuth credentials present)
 * 
 * @return bool True if configured
 */
...
/**
 * Check if Gmail is authenticated (tokens exist)
 * 
