    <nav class="navbar navbar-expand-lg sticky-top glass bg-body-tertiary shadow animate-nav">
        <div class="container-fluid px-3 mx-3 px-md-5">
            <a class="navbar-brand fw-bold fs-3" href="/HOTEL-MANAGEMENT-SYSTEM/index.php"><img id="site-logo" src="/HOTEL-MANAGEMENT-SYSTEM/images/logo/logoB.png" style="width: 120px;" alt="logo"></a>
            ...
            <div class="collapse navbar-collapse justify-content-center" id="mainNavbar">
                <div class="navbar-nav">
                    <a class="nav-link small text-body me-5" href="/HOTEL-MANAGEMENT-SYSTEM/index.php"><i class="bi bi-house-fill me-2"></i>HOME</a>
                    <a class="nav-link small text-body me-5" href="/HOTEL-MANAGEMENT-SYSTEM/frontend/rooms.php"><i class="bi bi-door-open me-2"></i>ROOMS</a>
                    <a class="nav-link small text-body me-5" href="/HOTEL-MANAGEMENT-SYSTEM/index.php#eventsContainer"><i class="bi bi-calendar-event me-2"></i>EVENTS</a>
                    <a class="nav-link small text-body me-5" href="/HOTEL-MANAGEMENT-SYSTEM/index.php#about"><i class="bi bi-info-circle me-2"></i>ABOUT</a>

                    <!-- Actions inside collapsed menu on small screens -->
                    <div class="d-flex d-lg-none mt-3">
                        <button class="btn btn-outline-dark me-2" onclick="location.href='/HOTEL-MANAGEMENT-SYSTEM/frontend/login.php'">Login</button>
                        <div class="vr mx-2"></div>
                        <button class="nav-link small text-body ms-2 border-0 bg-transparent" id="mode" type="button" onclick="changeMode()"><i class="bi bi-moon-fill"></i></button>
                    </div>
                </div>
            </div>
            ...
            <div class="d-none d-lg-flex align-items-center ms-auto">
                <button class="btn btn-outline-dark me-2" onclick="location.href='/HOTEL-MANAGEMENT-SYSTEM/frontend/login.php'">Login</button>
                <div class="vr mx-2"></div>
                <button class="nav-link small text-body ms-2 border-0 bg-transparent d-none d-lg-inline" id="mode-lg" type="button" onclick="changeMode()"><i class="bi bi-moon-fill"></i></button>
            </div>
        </div>
    </nav>
    <script>
