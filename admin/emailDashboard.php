...
require_once '../integrations/gmail/config.php';
            ...
            <div class="col-lg-10 p-4">
                ...
                <?php elseif (!$configStatus['is_authenticated']): ?>
                    <div class="alert alert-info">
                        ...
                        <a href="../integrations/gmail/googleLogin.php" class="btn btn-primary btn-sm ms-3">Connect Gmail Account</a>
                    </div>
                <?php endif; ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <ol class="mb-4">
                        ...
                        <li>Add Authorized Redirect URI: <code>http://localhost/Hotel-Management-System/integrations/gmail/googleCallback.php</code> (Adjust domain if live).</li>
